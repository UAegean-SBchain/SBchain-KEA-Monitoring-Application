...
//
    ...
    public void testWallet() throws IOException {
        Web3j web3 = Web3j.build(new HttpService("http://I4mlab-besu.westeurope.cloudapp.azure.com:8545"));
        String password = null; // no encryption
        String mnemonic = "talk prefer horse hope near copy time broken balance jaguar face scrap";
...
//
//            try {
//                Tuple9<byte[], BigInteger, List<BigInteger>, List<BigInteger>, BigInteger, List<BigInteger>, List<BigInteger>, List<BigInteger>, BigInteger> res = contract
